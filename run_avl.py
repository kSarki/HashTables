"""Entry point for running the AVL version of the course schedule program."""
...
def main():
    """Main function to run the AVL-based course schedule search."""
    schedule = Schedule()
    schedule.load_from_csv("courses.csv")
    print(f"Course schedule loaded (AVL version). Tree height: {schedule.get_tree_height()}")
