"""Schedule adapter using Binary Search Tree for course storage."""
...
class Schedule:
    """
    Course schedule manager using BST as the underlying data structure.
    
    Courses are stored with composite keys (subject, catalog, section)
    enabling efficient in-order traversal and prefix-based searches.
    """
    
    def __init__(self):
        """Initialize schedule with empty BST."""
        self.tree = BST()
    ...
    def get_tree_height(self) -> int:
        """Return the height of the underlying BST."""
